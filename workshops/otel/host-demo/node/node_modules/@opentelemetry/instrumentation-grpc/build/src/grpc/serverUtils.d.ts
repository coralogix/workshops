...
export declare const clientStreamAndUnaryHandler: <RequestType, ResponseType_1>(span: Span, call: ServerCallWithMeta, callback: SendUnaryDataCallback, original: grpcTypes.handleCall<RequestType, ResponseType_1> | grpcTypes.ClientReadableStream<RequestType>, self: {}) => any;
