        ...
        proto.logs = (function () {
            ...
            logs.v1 = (function () {
                ...
                v1.ResourceLogs = (function () {
                    ...
                    ResourceLogs.encode = function encode(message, writer) {
                        ...
                        if (message.instrumentationLibraryLogs != null && message.instrumentationLibraryLogs.length)
                            for (var i = 0; i < message.instrumentationLibraryLogs.length; ++i)
                    ...
                    ResourceLogs.decode = function decode(reader, length) {
                        ...
                        while (reader.pos < end) {
                            ...
                            switch (tag >>> 3) {
                                ...
                                case 1000: {
                                    if (!(message.instrumentationLibraryLogs && message.instrumentationLibraryLogs.length))
                                        message.instrumentationLibraryLogs = [];
                                    message.instrumentationLibraryLogs.push($root.opentelemetry.proto.logs.v1.InstrumentationLibraryLogs.decode(reader, reader.uint32()));
                                    break;
                                }
                                case 3: {
                                    message.schemaUrl = reader.string();
                    ...
                    ResourceLogs.verify = function verify(message) {
                        ...
                        if (message.instrumentationLibraryLogs != null && message.hasOwnProperty("instrumentationLibraryLogs")) {
                            if (!Array.isArray(message.instrumentationLibraryLogs))
                                return "instrumentationLibraryLogs: array expected";
                            for (var i = 0; i < message.instrumentationLibraryLogs.length; ++i) {
                                var error = $root.opentelemetry.proto.logs.v1.InstrumentationLibraryLogs.verify(message.instrumentationLibraryLogs[i]);
                                if (error)
                                    return "instrumentationLibraryLogs." + error;
                            }
                        }
                        if (message.schemaUrl != null && message.hasOwnProperty("schemaUrl"))
                            if (!$util.isString(message.schemaUrl))
                    ...
                    ResourceLogs.fromObject = function fromObject(object) {
                        ...
                        if (object.instrumentationLibraryLogs) {
                            if (!Array.isArray(object.instrumentationLibraryLogs))
                                throw TypeError(".opentelemetry.proto.logs.v1.ResourceLogs.instrumentationLibraryLogs: array expected");
                            message.instrumentationLibraryLogs = [];
                            for (var i = 0; i < object.instrumentationLibraryLogs.length; ++i) {
                                if (typeof object.instrumentationLibraryLogs[i] !== "object")
                                    throw TypeError(".opentelemetry.proto.logs.v1.ResourceLogs.instrumentationLibraryLogs: object expected");
                                message.instrumentationLibraryLogs[i] = $root.opentelemetry.proto.logs.v1.InstrumentationLibraryLogs.fromObject(object.instrumentationLibraryLogs[i]);
                            }
                        }
                        if (object.schemaUrl != null)
                            message.schemaUrl = String(object.schemaUrl);
                    ...
                    ResourceLogs.toObject = function toObject(message, options) {
                        ...
                        if (message.instrumentationLibraryLogs && message.instrumentationLibraryLogs.length) {
                            object.instrumentationLibraryLogs = [];
                            for (var j = 0; j < message.instrumentationLibraryLogs.length; ++j)
                                object.instrumentationLibraryLogs[j] = $root.opentelemetry.proto.logs.v1.InstrumentationLibraryLogs.toObject(message.instrumentationLibraryLogs[j], options);
                        }
                        return object;
                    };
                    /**
                ...
                v1.InstrumentationLibraryLogs = (function () {
                     ...
                     * @instance
                     */
                    InstrumentationLibraryLogs.prototype.schemaUrl = null;
                    /**
                     ...
                     * @static
                     * @param {opentelemetry.proto.logs.v1.IInstrumentationLibraryLogs=} [properties] Properties to set
                     * @returns {opentelemetry.proto.logs.v1.InstrumentationLibraryLogs} InstrumentationLibraryLogs instance
                     */
                    InstrumentationLibraryLogs.create = function create(properties) {
                        return new InstrumentationLibraryLogs(properties);
                    };
                    /**
                     ...
                     * @returns {$protobuf.Writer} Writer
                     */
                    InstrumentationLibraryLogs.encodeDelimited = function encodeDelimited(message, writer) {
                        return this.encode(message, writer).ldelim();
                    };
                    /**
                     ...
                     * @param {$protobuf.Reader|Uint8Array} reader Reader or buffer to decode from
                     * @param {number} [length] Message length if known beforehand
                     * @returns {opentelemetry.proto.logs.v1.InstrumentationLibraryLogs} InstrumentationLibraryLogs
                     * @throws {Error} If the payload is not a reader or valid buffer
                     * @throws {$protobuf.util.ProtocolError} If required fields are missing
                     */
                    InstrumentationLibraryLogs.decode = function decode(reader, length) {
                        if (!(reader instanceof $Reader))
                            reader = $Reader.create(reader);
                        var end = length === undefined ? reader.len : reader.pos + length, message = new $root.opentelemetry.proto.logs.v1.InstrumentationLibraryLogs();
                        while (reader.pos < end) {
                            var tag = reader.uint32();
                            switch (tag >>> 3) {
                                case 1: {
                     ...
                     * @throws {$protobuf.util.ProtocolError} If required fields are missing
                     */
                    InstrumentationLibraryLogs.decodeDelimited = function decodeDelimited(reader) {
                        if (!(reader instanceof $Reader))
                            reader = new $Reader(reader);
                        return this.decode(reader, reader.uint32());
                    };
                     ...
                     * @returns {string|null} `null` if valid, otherwise the reason why it is not
                     */
                    InstrumentationLibraryLogs.verify = function verify(message) {
                        if (typeof message !== "object" || message === null)
                            return "object expected";
                        if (message.instrumentationLibrary != null && message.hasOwnProperty("instrumentationLibrary")) {
                            var error = $root.opentelemetry.proto.common.v1.InstrumentationLibrary.verify(message.instrumentationLibrary);
                     ...
                     * @returns {opentelemetry.proto.logs.v1.InstrumentationLibraryLogs} InstrumentationLibraryLogs
                     */
                    InstrumentationLibraryLogs.fromObject = function fromObject(object) {
                        if (object instanceof $root.opentelemetry.proto.logs.v1.InstrumentationLibraryLogs)
                            return object;
                        var message = new $root.opentelemetry.proto.logs.v1.InstrumentationLibraryLogs();
                        if (object.instrumentationLibrary != null) {
                            if (typeof object.instrumentationLibrary !== "object")
                                throw TypeError(".opentelemetry.proto.logs.v1.InstrumentationLibraryLogs.instrumentationLibrary: object expected");
                            message.instrumentationLibrary = $root.opentelemetry.proto.common.v1.InstrumentationLibrary.fromObject(object.instrumentationLibrary);
                        }
                        if (object.logRecords) {
                            if (!Array.isArray(object.logRecords))
                                throw TypeError(".opentelemetry.proto.logs.v1.InstrumentationLibraryLogs.logRecords: array expected");
                            message.logRecords = [];
                            for (var i = 0; i < object.logRecords.length; ++i) {
                                if (typeof object.logRecords[i] !== "object")
                                    throw TypeError(".opentelemetry.proto.logs.v1.InstrumentationLibraryLogs.logRecords: object expected");
                                message.logRecords[i] = $root.opentelemetry.proto.logs.v1.LogRecord.fromObject(object.logRecords[i]);
                            }
                        }
                        if (object.schemaUrl != null)
                     ...
                     * @memberof opentelemetry.proto.logs.v1.InstrumentationLibraryLogs
                     * @static
                     * @param {opentelemetry.proto.logs.v1.InstrumentationLibraryLogs} message InstrumentationLibraryLogs
                     * @param {$protobuf.IConversionOptions} [options] Conversion options
                     * @returns {Object.<string,*>} Plain object
                     */
                    InstrumentationLibraryLogs.toObject = function toObject(message, options) {
                        if (!options)
                            options = {};
                        var object = {};
                        if (options.arrays || options.defaults)
                     ...
                     * @returns {Object.<string,*>} JSON object
                     */
                    InstrumentationLibraryLogs.prototype.toJSON = function toJSON() {
                        return this.constructor.toObject(this, $protobuf.util.toJSONOptions);
                    };
                    /**
                     * Gets the default type url for InstrumentationLibraryLogs
                     * @function getTypeUrl
                     * @memberof opentelemetry.proto.logs.v1.InstrumentationLibraryLogs
                     * @static
                     * @param {string} [typeUrlPrefix] your custom typeUrlPrefix(default "type.googleapis.com")
                     * @returns {string} The default type url
                     */
                    InstrumentationLibraryLogs.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
                        if (typeUrlPrefix === undefined) {
                            typeUrlPrefix = "type.googleapis.com";
                        }
                        return typeUrlPrefix + "/opentelemetry.proto.logs.v1.InstrumentationLibraryLogs";
                    };
